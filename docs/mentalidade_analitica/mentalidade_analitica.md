...
> **Observação:** este documento descreve **stakeholders, dados e indicadores** sob a ótica analítica e não deve ser confundido com um conjunto de regras de negócio. Ele mapeia quem usa quais dados e quais perguntas cada papel precisa responder; não especifica políticas, restrições ou fluxos de processamento que definem o funcionamento do sistema. Regras de negócio têm seu próprio artefato, criado em `documentacao/regras_negocio.md`.
