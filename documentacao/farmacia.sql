...
USE `farmacia`;
-- MySQL dump — Projeto Farmacia
-- Dump gerado a partir dos DDLs em database/tabelas/
-- Ordem das tabelas: dependências respeitadas (referenciais → principais → associativas)
...
--
-- Referenciais (sem dependência entre si)
--
...
--
-- Principais (ordem por dependência: cidade → usuario → endereco → produto → historico)
--
...
-- Dump atualizado a partir dos DDLs do projeto (fevereiro/2026)
